...
namespace cs221util {
  ...
  public:
    /**
      * Creates an empty RGBA_PNG image.
      */
    RGBA_PNG();

    /**
      * Creates a RGBA_PNG image of the specified dimensions.
      * @param width Width of the new image.
      * @param height Height of the new image.
      */
    RGBA_PNG(unsigned int width, unsigned int height);  

    /**
      * Copy constructor: creates a new RGBA_PNG image that is a copy of
      * another.
      * @param other RGBA_PNG to be copied.
      */
    RGBA_PNG(RGBA_PNG const & other);

    /**
      * Destructor: frees all memory associated with a given RGBA_PNG object.
      * Invoked by the system.
      */
    ~RGBA_PNG();
  
    /**
      * Assignment operator for setting two RGBA_PNGs equal to one another.
      * @param other Image to copy into the current image.
      * @return The current image for assignment chaining.
      */
    RGBA_PNG const & operator= (RGBA_PNG const & other);
    ...
    /**
      ...
      */
    bool operator== (RGBA_PNG const & other) const;
    ...
    /**
      * Reads in a RGBA_PNG image from a file.
      * Overwrites any current image content in the RGBA_PNG.
    ...
    /**
      * Writes a RGBA_PNG image to a file.
  ...
  private:
     ...
     */
     void _copy(RGBA_PNG const & other);
  };
}
